...
from advertise_x import config
from advertise_x.models.predict import predict
from advertise_x.response_handler import APIResponseHandler

ALLOWED_EXTENSIONS = {'png', 'jpg', 'jpeg', 'pdf', 'xlsx'}

app = Flask('Advertise X')
app.config['UPLOAD_FOLDER'] = config.DATA_FOLDER
router = '/advertise-x/' + config.ENV
